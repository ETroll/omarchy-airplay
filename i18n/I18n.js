...
var messages = {
  en: {
    ...
    pairNewReceiver: "AUTHORIZE RECEIVER",
    pinHelp: "Enter the PIN shown by the receiver, or its configured AirPlay password.",
    pin: "PIN or password",
    ...
    connectionFailed: "DoubleTake exited with code {code}. Enter the receiver PIN or AirPlay password below and choose Pair & connect.",
  ...
  nb: {
    ...
    pairNewReceiver: "AUTORISER MOTTAKER",
    pinHelp: "Skriv inn PIN-koden som vises på mottakeren, eller det konfigurerte AirPlay-passordet.",
    pin: "PIN eller passord",
    ...
    connectionFailed: "DoubleTake avsluttet med kode {code}. Skriv inn mottakerens PIN eller AirPlay-passord under og velg Par og koble til.",
